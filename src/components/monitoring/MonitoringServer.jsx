        ...
        <li className="monitoring__item">
            ...
            <ul className="monitoring__data-list">
                ...
                <li>
                    ...
                    <div>
                        <p>{server.numberOfFail}</p>
                        <p>μ{server.averageNumberOfFail}</p>
                    </div>
                </li>
            </ul>
        </li>
