...
const RootForm = ({serverList, editable, closeModal, addNewItem, editCItem}) => {
    ...
    const [createItem, ciIsLoading] = useApi({
        url: '/profile-monitoring-system/network/root/create',
        data: formData
    })
            ...
            <div className="modal-network__form">
                <div className="modal-network__content modal-network-main">
                    <div className="modal-network__form-item flex-33">
                        <div className="modal-network__item-title-box"><p>IP-АДРЕС ROOT-СЕРВЕРА</p></div>
