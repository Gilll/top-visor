...
const CaptchaItem = ({server, deleteItem, editItem}) => {
    ...
    return (
        <div className="captcha__item" data-id="1000">
            <div>
                <Dropdown
                    menu={{
                        items,
            ...
            <div>
                ...
                :
                    <div className="home__status-icon disable"/>
                }
            </div>
            <div>
                {server.affiliation === "OUR" ?
                    <div className="home__status-owner OUR">
                ...
                :
                    <div className="home__status-owner RENT">
