...
const ProjectListItem = ({project, callMap}) => {
    return (
        <Link to={routeNames.project + '/' + project.id} className="projects__item" id={"project" + project.id} >
            <div className="projects__item-name">
                <div className="projects__item-icon">
                    <img src={projectIcon} alt=""/>
                </div>
                <p>{project.name}</p>
                <sup>???</sup>
            </div>
            <div className="projects__item-qty-servers">
            ...
            <a href="#topVisor" className="projects__item-topvisor">
                <span>{project.topVisorId}</span>
            ...
            <a href={project.statisticLink} target='_blank' rel='noreferrer' className="projects__item-stat" onClick={e => e.stopPropagation()}>
                <IconLinkToDoc/>
            </a>
            <a href={"https://" + project.siteLink} target="_blank" rel='noreferrer' className="projects__item-url" onClick={e => e.stopPropagation()}>
                {project.siteLink}
            </a>
